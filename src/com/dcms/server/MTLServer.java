 ...
 *
 * MTL Server Class
 * Create web service for MTL location
 */
...
public class MTLServer {
    ...
    public static void main(String[] args) {
        ...
        try{
        	...
        	Endpoint endpoint = Endpoint.publish(LocationConstants.MONTREAL_ADDRESS, centerServerImpl);
    		
        	/*Check whether web service is published or not*/
        	activityLogger.log(MessageTypeConstants.INFO, "Montreal Service is Published : " + endpoint.isPublished());
