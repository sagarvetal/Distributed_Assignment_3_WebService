 ...
 * 
 * DDO Server Class
 * Create web service for DDO location
 */
...
public class DDOServer {
	...
	public static void main(String[] args) {
	    ...
	    try{
	    	...
	    	final CenterServerImpl centerServerImpl = new CenterServerImpl(LocationConstants.DOLLARD);
	    	
	    	/*Binding it to service registry --> WSDL file is created*/
	    	Endpoint endpoint = Endpoint.publish(LocationConstants.DOLLARD_ADDRESS, centerServerImpl);
			
	    	/*Check whether web service is published or not*/
	    	activityLogger.log(MessageTypeConstants.INFO, "Dollard-des-Ormeaux Service is Published : " + endpoint.isPublished());
